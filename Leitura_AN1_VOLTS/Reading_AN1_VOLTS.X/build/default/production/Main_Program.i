...
void main()
{
    ...
    while(1)
    {
        ...
        else if(TensaoAN1 > 1.50 && TensaoAN1 <= 2.75)
        {
            PORTDbits.RD0 = 0;
            PORTDbits.RD1 = 1;
            PORTDbits.RD2 = 1;
        ...
        else if(TensaoAN1 > 2.75 && TensaoAN1 <= 3.50)
        {
            PORTDbits.RD0 = 0;
            PORTDbits.RD1 = 0;
            PORTDbits.RD2 = 1;
        ...
        else if(TensaoAN1 > 3.50 && TensaoAN1 <= 4.25)
        {
            PORTDbits.RD0 = 0;
            PORTDbits.RD1 = 0;
            PORTDbits.RD2 = 0;
